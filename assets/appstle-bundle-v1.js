    ...
    $(function() {
      ...
      function getBundleLevelDataAcrossItems(bundle) {
        ...
        if (bundle.discountType === 'PERCENTAGE') {
          bundle.formattedDiscount = bundle.discountValue + '%';
      ...
      function createVariantBundleHTML(variantLevelBundles, currentVariantData, currentProductData) {
        var bundleTemplate = `<div class="as-bundle-wrapper" data-bundle-id={{bundle.id}}>
                  ...
                  <div class="as-current-product" data-product-handle="{{{currentProductData.handle}}}">
                    ...
                    <a href="/products/{{{currentProductData.handle}}}?variant={{currentVariantData.id}}"><img src="{{currentProductData.featured_image}}" class="as-current-product_image"></a>
                    <div class="as-bundle-product_details">
                      <a class="as-current-product_name" href="/products/{{{currentProductData.handle}}}?variant={{currentVariantData.id}}">{{currentVariantData.bundleVariantTitle}}</a>
                  ...
                  <div class="as-bundle-product" data-product-handle="{{{productHandle}}}">
                    ...
                    <a href="/products/{{{productHandle}}}?variant={{id}}"><img src="{{imageSrc}}" class="as-bundle-product_image"></a>
                    <div class="as-bundle-product_details">
                      <a class="as-bundle-product_name" href="/products/{{{productHandle}}}?variant={{id}}">{{bundleVariantTitle}}</a>
      ...
      function createProductBundleHTML(productLevelBundles, productData) {
        var bundleTemplate = `<div class="as-bundle-wrapper" data-bundle-id={{bundle.id}}>
                  ...
                  <div class="as-current-product" data-product-handle="{{{currentProductData.productData.handle}}}">
                    ...
                    <a href="/products/{{{currentProductData.productData.handle}}}"><img src="{{currentProductData.productData.featured_image}}" class="as-bundle-product_image"></a>
                    <div class="as-bundle-product_details">
                      <a class="as-bundle-product_name" href="/products/{{{currentProductData.productData.handle}}}">{{currentProductData.title}}</a>
                      <div class="as-bundle-product_price">
                  ...
                  <div class="as-bundle-product" data-product-handle="{{{productData.handle}}}">
                          ...
                          <a href="/products/{{{productData.handle}}}"><img src="{{productData.featured_image}}" class="as-bundle-product_image"></a>
                          <div class="as-bundle-product_details">
                              <a class="as-bundle-product_name" href="/products/{{{productData.handle}}}">{{title}}</a>
                              <div class="as-bundle-product_price">
                                  <span class="as-sale-price">{{{formattedPrice}}}</span>{{#bundle.showCompareAtPrice}}&nbsp;<span class="as-original-price">{{{formattedOriginalPrice}}}</span>{{/bundle.showCompareAtPrice}}
                              </div>
                              <div class="as-select-wrapper">
      ...
      function attatchEventHandlerToBundleCheckoutButton() {
        jQuery(document).on('click', '.as-bundle-cart', function() {
      ...
      function attatchEventHandlerToBundleCheckoutSellingPlanSelect() {
        jQuery(document).on('change', '.as-sellingPlan-select-checkout', function(event) {
          var instance = this;
      ...
      function attatchEventHandlerToBundlePopupButton() {
        jQuery(document).on('click', '.as-bundle-checkout', function() {
          setBundleInProgress(this);
      ...
      function attatchEventHandlerToBundleCancelButton() {
        jQuery(document).on('click', '.as-bundle-cancel', function() {
          jQuery(this)
      ...
      function attachEventHandlerToItemCheckbox() {
        jQuery(document).on('change', '.as-checkmark-round input[type=checkbox]', function(event) {
          var instance = this;
      ...
      function sendCartDataAndGetDiscount(cartData, instance) {
        ...
        fetch('/apps/subscriptions/cart-discount', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json'
          },
      ...
      function buildSlidePopupView(bundles, cartData) {
        ...
        if (bundles.length && bundles[0]?.discountValue) {
          ...
          if (!jQuery('.as-bundle-loading').length) {
      ...
      function attatchChangeHandlerToVariant() {
        jQuery(document).on('change', '.as-variant-select', function(event) {
          var productData =
            window.products[
              jQuery(this)
                .parents('.as-bundle-product, .as-current-product')
      ...
      function attatchChangeHandlerToSellingPlan() {
        jQuery(document).on('change', '.as-sellingPlan-select', function(event) {
              ...
              if (visible) {
                ...
                if (bundle?.showCombinedSellingPlan) {
                  ...
                  if (!checkoutSelect.find(`option[value=${sellingPlan.id}]`).length) {
                    var isSelected = bundle?.selectSubscriptionByDefault ? (checkoutSelect.find(`option`).length === 1) : false;
...
.as-variant-select, .as-sellingPlan-select, .as-sellingPlan-select-checkout {
  padding: 5px;
  border-radius: 8px;
}
